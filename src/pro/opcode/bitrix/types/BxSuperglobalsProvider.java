...
public class BxSuperglobalsProvider extends CompletionContributor implements PhpTypeProvider2
{
	...
	private static final HashMap<String, BxSuperglobal> bxSuperglobals = new HashMap<String, BxSuperglobal>(); static {
		...
		bxSuperglobals.put("arResult",				new BxSuperglobal("GLOBALS",					Arrays.asList("template.php", "results_modifier.php", "component_epilog.php")));
		bxSuperglobals.put("arParams",				new BxSuperglobal("GLOBALS",					Arrays.asList("template.php", "results_modifier.php", "component_epilog.php")));
		...
		bxSuperglobals.put("componentPath",			new BxSuperglobal("php_errormsg",				Arrays.asList("template.php", "results_modifier.php", "component_epilog.php")));
	}
