...
public class BxSuperglobalsProvider extends CompletionContributor implements PhpTypeProvider2
{
	...
	private static final HashMap<String, BxSuperglobal> bxSuperglobals = new HashMap<String, BxSuperglobal>(); static {
		...
		bxSuperglobals.put("this",					new BxSuperglobal("CBitrixComponentTemplate",	Arrays.asList("template.php", "results_modifier.php", "component_epilog.php"					)));
		bxSuperglobals.put("component",				new BxSuperglobal("CBitrixComponent",			Arrays.asList("template.php", "results_modifier.php", "component_epilog.php"					)));
		bxSuperglobals.put("arResult",				new BxSuperglobal("GLOBALS",					Arrays.asList("template.php", "results_modifier.php", "component_epilog.php", "component.php"	)));
		bxSuperglobals.put("arParams",				new BxSuperglobal("GLOBALS",					Arrays.asList("template.php", "results_modifier.php", "component_epilog.php", "component.php"	)));
		bxSuperglobals.put("arLangMessages",		new BxSuperglobal("GLOBALS",					Arrays.asList("template.php", "results_modifier.php", "component_epilog.php"					)));
		bxSuperglobals.put("templateName",			new BxSuperglobal("php_errormsg",				Arrays.asList("template.php", "results_modifier.php", "component_epilog.php"					)));
		bxSuperglobals.put("templateData",			new BxSuperglobal("php_errormsg",				Arrays.asList("template.php", "results_modifier.php", "component_epilog.php"					)));
		bxSuperglobals.put("templateFile",			new BxSuperglobal("php_errormsg",				Arrays.asList("template.php", "results_modifier.php", "component_epilog.php"					)));
		bxSuperglobals.put("templateFolder",		new BxSuperglobal("php_errormsg",				Arrays.asList("template.php", "results_modifier.php", "component_epilog.php"					)));
		bxSuperglobals.put("parentTemplateFolder",	new BxSuperglobal("php_errormsg",				Arrays.asList("template.php", "results_modifier.php", "component_epilog.php"					)));
		bxSuperglobals.put("componentPath",			new BxSuperglobal("php_errormsg",				Arrays.asList("template.php", "results_modifier.php", "component_epilog.php", "component.php"	)));
	}
